...
class Ui_frameRelat(object):
    def setupUi(self, frameRelat):
        ...
        for x in result:
            ...
            self.tableWidget.setItem(cont, 0, QtWidgets.QTableWidgetItem(str(id)))
            self.tableWidget.setItem(cont, 1, QtWidgets.QTableWidgetItem(data.strftime("%d/%m/%Y %H:%M")))
            self.tableWidget.setItem(cont, 2, QtWidgets.QTableWidgetItem(placa))
            self.tableWidget.setItem(cont, 3, QtWidgets.QTableWidgetItem(cor))
            self.tableWidget.setItem(cont, 4, QtWidgets.QTableWidgetItem(fabricante))
            ...
            self.tableWidget.setItem(cont, 7, QtWidgets.QTableWidgetItem(modelo))
